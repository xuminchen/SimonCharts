...
- magnet helpers: `createOhlcMagnetTargets()`, `createDrawingAnchorMagnetTargets()`, `createVisualPointMagnetTargets()`, `findNearestMagnetTarget()`, `snapPointToMagnetTargets()`, `getMagnetSnapState()`, `MagnetSnapState`, `MagnetSnapStateOptions`
