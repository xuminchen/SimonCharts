...
The accepted immutable package artifact is `dist/packages/simoncharts-charts-1.0.0-rc.41.tgz` (8 files), SHA-256 `46a062ed41434d465ca4c236d79fdb35f67519a1b1f4a0041dbb277b9f22ae87`, SHA-512 `6288b8e5dba12c8e58c7cbed7b8aa53e7c535a2c0357adfd80fd484eca1f374d6371a07a6c5e4383fea050568c044d031f055e00ec16fb5b82603e6aa1c65df2`. Its package-only commercial gate passed `70 files / 1,235 tests`, combined Chrome `150/150`, Charts `15 files / 226 tests`, Charts Chrome/Edge `99/99` per browser, and exact packed JavaScript/TypeScript Chrome/Edge consumer execution. The immutable rc.40 artifact remains preserved but rejected after adversarial review found that a failed requested history range could leave `dataReady()` pending; authenticated reference-host acceptance remains the separate final commercial gate described below.
