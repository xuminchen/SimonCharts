...
rc.30 adds dedicated public `crosshair-moved` and `crosshair-left` subscriptions. Movement snapshots are coalesced to the latest real position once per animation frame and include the accepted symbol/timeframe/adjustment/data revision, raw candle, nullable real-reference change values, canvas offsets, and all outputs of visible study instances; same-candle price changes remain observable and selection changes cannot leak stale events. It builds on rc.29's independent study instances and rc.28's incremental Entity API.
...
The accepted immutable package artifact is `dist/packages/simoncharts-charts-1.0.0-rc.30.tgz` (8 files), SHA-256 `a837f0a39c13595d3959c5c6a8b90804b69373326a236c0162c397bd220bd02c`, SHA-512 `33af89105f88c813be383f5861fa15775a086a00c0e29fe6fd8e5e5d95b6eedd42ef85ecf403842c347a865338078744ba288ccf578881413c64fe32a24539f4`. Its package-only commercial gate passed `69 files / 1,116 tests`, combined Chrome `102/102`, Charts `14 files / 140 tests`, and Charts Chrome/Edge `51/51` per browser; authenticated reference-host acceptance remains the separate final commercial gate described below.
