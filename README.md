...
rc.29 separates indicator definitions from stable study instances. Hosts can create multiple copies of one definition through `createStudy()`, address them through opaque IDs, and round-trip them through `ChartLayoutV2`; calculation checkpoints, output IDs, panels, UI actions, persistence, and data-window rows stay isolated per instance. It builds on rc.28's incremental Entity API and lifecycle events without a second state store.
...
The accepted immutable package artifact is `dist/packages/simoncharts-charts-1.0.0-rc.29.tgz` (8 files), SHA-256 `b5efabbfa50242ccadd73911e3eccd8626583c9553a1806d005c6d484bf27097`, SHA-512 `c8c1c57e6deb48c05cf7c18a361ebb98a5a826a228ebd4d74ab1cac8e3db8f75443daa0dff9e9ef675847731368a19fd28de62b64e9fdddf70d029b24f4cf35e`. Its package-only commercial gate passed `69 files / 1,115 tests`, combined Chrome `100/100`, Charts `14 files / 139 tests`, and Charts Chrome/Edge `49/49` per browser; authenticated reference-host acceptance remains the separate final commercial gate described below.
